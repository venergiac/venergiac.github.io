...
def load_and_convert_wav_path(file_path:str, dest_path:str = "data/temp"):

    # 1. Load the audio file
    #file_path = 'data/pump/id_06/abnormal/00000097.wav'
    #file_path = 'data/pump/id_06/normal/00001033.wav'
